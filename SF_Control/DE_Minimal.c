...
clang -march=native `pkg-config --cflags cairo --libs cairo` -shared -o control_frame_lib.so myvars.o HM.o RS.o TCOL.o DE_Minimal.o -O3;
...
clang -march=native `pkg-config --cflags cairo --libs cairo` -shared -o control_frame_lib_FULL.so myvars.o HM.o RS.o TCOL.o DE_Minimal.o -O3 -D GUI_INTERFACE;
