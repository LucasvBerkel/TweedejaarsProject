...
# do like more fancy parsing here
...
#game_path=$PWD"/roms/"
game_path="/Users/rijnderwever/Desktop/NLR/NLR/TweedejaarsProject/gym-master/gym/envs/space_fortress/darwin/control_frame_lib.so"
env_params="useRGB=false"
agent="NeuralQLearner"
n_replay=1
netfile="\"convnet_atari3\""
update_freq=4
actrep=3 # lower this maybe, or lower ROTATE_ANGLE  
discount=0.99
seed=1
learn_start=50000
pool_frms_type="\"max\""
